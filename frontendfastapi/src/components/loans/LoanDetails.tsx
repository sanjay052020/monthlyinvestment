...
import { fetchLoan, fetchLoans } from "../../features/loans/loanThunks";
      ...
      <div className={styles.box}>
        ...
        <table className={styles.detailsTable}>
          <tbody>
            ...
            <tr><th>Start Date</th><td>{loan.start_date.slice(0, 10)}</td></tr>
            <tr><th>End Date</th><td>{loan.end_date.slice(0, 10)}</td></tr>
            <tr><th>Completed Months</th><td>{loan.months}</td></tr>
            <tr><th>Total Amount</th><td>{formatIndianAmount(loan?.total_amount || "")}</td></tr>
